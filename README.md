...
- Аккуратнее оформлен Twitch-плеер: рамка, отступы, чистый блок действий без дублирования нативных контролов.
- Улучшены карточки «Клипы / VOD»: метки, кнопка воспроизведения, hover-состояния, визуальная иерархия.
- Кнопки соцсетей стали выразительнее: карточки с названием, назначением и индивидуальным hover-эффектом.
