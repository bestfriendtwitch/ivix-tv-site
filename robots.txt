...
<head>
  ...
  <meta property="og:image" content="https://ivixtv.ru/assets/og-preview.png" />
  ...
  <meta name="twitter:image" content="https://ivixtv.ru/assets/og-preview.png" />
...
<body>
  ...
  <header class="site-header">
    ...
    <nav class="main-nav" aria-label="Основная навигация">
      ...
      <a href="#schedule">Анонсы</a>
      <a href="#clips">Клипы</a>
      <a href="#community">Команды</a>
      <a href="#links">Ссылки</a>
      <a href="#support">Поддержать</a>
    </nav>

    <div class="header-actions">
      <a class="icon-link" href="https://t.me/ivixitsme" target="_blank" rel="noreferrer" aria-label="Telegram">✈</a>
      <a class="icon-link" href="https://www.twitch.tv/ivix_tv" target="_blank" rel="noreferrer" aria-label="Twitch">▣</a>
  ...
  <main id="home">
    <section class="hero section-pad">
      <div class="hero-copy reveal">
        <div class="eyebrow">Стример на Twitch</div>
        <h1>IVIX_TV</h1>
        ...
        <div class="hero-buttons">
          <a class="btn btn-primary btn-lg" href="https://www.twitch.tv/ivix_tv" target="_blank" rel="noreferrer"><span class="btn-icon">▣</span> Смотреть на Twitch</a>
        ...
        <div class="social-row" id="socials">
          <a href="https://t.me/ivixitsme" target="_blank" rel="noreferrer"><span>✈</span> Telegram</a>
          <a href="https://vk.com/ivixitsme" target="_blank" rel="noreferrer"><span>vk</span> ВКонтакте</a>
          <a href="https://www.youtube.com/@ivixitsme" target="_blank" rel="noreferrer"><span>▶</span> YouTube</a>
          <a href="https://www.tiktok.com/@ivixitsme" target="_blank" rel="noreferrer"><span>♪</span> TikTok</a>
        </div>
      </div>

      <div class="stream-zone reveal delay-1">
        <article class="stream-card glass">
          <div class="card-top"><strong><span class="live-dot"></span> Сейчас в эфире</strong></div>
          <div class="player-frame">
            <div class="player-wrap" data-channel="ivix_tv">
              <iframe id="twitch-player" title="Twitch stream ivix_tv" allowfullscreen loading="lazy"></iframe>
          ...
          <div class="stream-actions">
            <span>Плеер Twitch встроен прямо на сайт. На телефоне чат удобнее открывать отдельно.</span>
            <a href="https://www.twitch.tv/ivix_tv" target="_blank" rel="noreferrer">Открыть на Twitch →</a>
          </div>
        </article>
    ...
    <section class="quick-strip section-pad reveal delay-2" aria-label="Быстрые действия">
      <a class="quick-item" href="https://t.me/ivixitsme" target="_blank" rel="noreferrer"><b>Анонсы</b><span>Telegram с расписанием и переносами</span></a>
      <a class="quick-item" href="https://dalink.to/ivix_tv" target="_blank" rel="noreferrer"><b>Все ссылки</b><span>Соцсети, донат и актуальные переходы</span></a>
      <a class="quick-item" href="https://www.twitch.tv/ivix_tv/clips?range=all" target="_blank" rel="noreferrer"><b>Клипы</b><span>Лучшие моменты на Twitch</span></a>
    </section>

    <section class="dashboard section-pad">
      <article class="panel schedule glass reveal" id="schedule">
        ...
        <div class="announce-card">
          <div class="announce-badge"><span class="live-dot"></span> Плавающий график</div>
      ...
      <article class="panel clips glass reveal delay-1" id="clips">
        ...
        <div class="clip-grid">
          <a class="clip-card" href="https://www.twitch.tv/ivix_tv/clips?range=all" target="_blank" rel="noreferrer">
            <div class="clip-thumb face-one"><span>Clip</span><i aria-hidden="true">▶</i></div>
          ...
          <a class="clip-card" href="https://www.twitch.tv/ivix_tv/videos?filter=clips&range=30d" target="_blank" rel="noreferrer">
            <div class="clip-thumb camp"><span>30d</span><i aria-hidden="true">▶</i></div>
          ...
          <a class="clip-card" href="https://www.twitch.tv/ivix_tv/videos" target="_blank" rel="noreferrer">
            <div class="clip-thumb face-two"><span>VOD</span><i aria-hidden="true">▶</i></div>
        ...
        <div class="panel-hint">Автоподгрузку клипов подключим позже через Twitch API, когда будет доступ к Developer App.</div>
      </article>

      <article class="panel about glass reveal delay-2">
      ...
      <article class="panel social-panel glass reveal delay-1" id="links">
        <div class="panel-title"><span class="purple-icon">↗</span><h2>Все ссылки</h2></div>
        <p class="panel-copy">Соцсети, донат, клипы и все актуальные переходы в одном месте.</p>
        <div class="social-icons social-icons-rich">
          <a class="social-link tg" href="https://t.me/ivixitsme" target="_blank" rel="noreferrer" aria-label="Telegram"><span>✈</span><b>Telegram</b><small>Анонсы и новости</small></a>
          <a class="social-link vk" href="https://vk.com/ivixitsme" target="_blank" rel="noreferrer" aria-label="VK"><span>vk</span><b>ВКонтакте</b><small>Сообщество</small></a>
          <a class="social-link yt" href="https://www.youtube.com/@ivixitsme" target="_blank" rel="noreferrer" aria-label="YouTube"><span>▶</span><b>YouTube</b><small>Видео и записи</small></a>
          <a class="social-link tw" href="https://www.twitch.tv/ivix_tv" target="_blank" rel="noreferrer" aria-label="Twitch"><span>▣</span><b>Twitch</b><small>Смотреть стрим</small></a>
          <a class="social-link tt" href="https://www.tiktok.com/@ivixitsme" target="_blank" rel="noreferrer" aria-label="TikTok"><span>♪</span><b>TikTok</b><small>Короткие моменты</small></a>
        </div>
        <a class="btn btn-ghost full" href="https://dalink.to/ivix_tv" target="_blank" rel="noreferrer">Открыть DaLink</a>
      </article>

      <article class="panel support glass reveal delay-2" id="support">
        <div>
          <div class="panel-title"><span class="purple-icon">♡</span><h2>Поддержать канал</h2></div>
          <p>Любая поддержка помогает развивать канал, делать больше контента и радовать чат новыми эфирами. Если хочешь поддержать IVIX_TV — вот удобный способ.</p>
          <a class="btn btn-primary" href="https://www.donationalerts.com/r/ivix_tv" target="_blank" rel="noreferrer">Поддержать</a>
        </div>
        <div class="jar" aria-hidden="true"><span>Спасибо<br>за поддержку!</span></div>
      </article>

      <article class="panel install-panel glass reveal delay-2">
        <div class="panel-title"><span class="purple-icon">▥</span><h2>На телефон</h2></div>
        <p class="panel-copy">Сохрани сайт на главный экран, чтобы быстро открывать стрим, ссылки и анонсы.</p>
        <div class="install-steps">
          <span>iPhone: Поделиться → На экран «Домой»</span>
          <span>Android: ⋮ → Добавить на главный экран</span>
        </div>
      </article>
    </section>
  ...
  <!-- Cloudflare Web Analytics --><script defer src='https://static.cloudflareinsights.com/beacon.min.js' data-cf-beacon='{"token": "ab0bc7a78ba94955bf17d43b6946ba46"}'></script><!-- End Cloudflare Web Analytics -->
</body>
</html>
